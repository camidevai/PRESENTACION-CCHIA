  ...
  return (
    <EpisodeLayout episode={episode} goNext={goNext} goPrev={goPrev} hasNext={hasNext} hasPrev={hasPrev}>
      <div className="flex flex-col items-center justify-center gap-4 w-full min-h-full">
        ...
        <EpisodeTitle lead="Generamos valor para el ecosistema" highlight="y para Chile." />
        ...
        >
          ...
          >
            <img
              src="/Definición y Propósito/Definición y Propósito-01.png"
              alt="Definición y Propósito"
              style={{
                width: '100%',
                height: '100%',
                objectFit: 'cover',
